...
const contactDetails = [
  ...
  },
  {
    ...
    label: 'WhatsApp',
    value: 'Chat with us',
    href: 'https://wa.me/919876543210?text=Hi%20Paint%20%26%20Keep!',
  },
  {
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    label: 'Facebook',
    value: 'Paint & Keep',
    href: 'https://facebook.com/paintandkeep',
  },
  {
    icon: (
      <svg
    ...
    label: 'Email',
    value: 'hello@paintandkeep.com',
    href: 'mailto:hello@paintandkeep.com',
  },
];
            ...
            >
              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="rounded-2xl overflow-hidden shadow-card aspect-[4/3]">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.5756493654437!2d77.6070627!3d12.9347862!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae15c099a0b395%3A0xa9b89168cc4a3f32!2sBangalore%2C%20Karnataka%2C%20India!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Paint & Keep office location on Google Maps"
                  />
                </div>
              </motion.div>
            </motion.div>
